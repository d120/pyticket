    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_group', models.ForeignKey(blank=True, help_text='Die Gruppe, für die das Ticket interessant ist.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='auth.Group', verbose_name='gruppe')),
